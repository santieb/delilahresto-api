      ...
      ? (
        ...
        <div class="p-4 bg-white rounded-lg border shadow-md">
          ...
          <form onSubmit={handleBuy}>
            ...
            <label onChange={({target}) => setAddress(target.value)} for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Select your address</label>
